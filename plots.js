...
let trace3 = {
  x: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Nov", "Dec"],
  y: [972.0055662069, 888.3816247487, 989.8579528958, 1098.639370091, 1150.8200937223, 1068.2638146546, 1252.4768737026, 1161.170967515, 1041.672666404, 918.7095587685, 851.950336669, 794.9204974786,].map(value => value/60),
...
let trace4 = {
  x: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Nov", "Dec"],
  y: [668.1730071112, 641.0504996124, 637.6856866745, 663.6483775007, 723.1278433685, 714.6819067819, 736.9871153065, 727.6911250322, 715.0041264843, 670.1628204503, 658.0061103118, 632.845873095].map(value => value/60),
...
let layout = {
  title: {
    text: 'Monthly User Count and Duration of Casual vs. Members',
    font: {
...
let data3 = [{
  x: ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"],
  y: [1011.111382906,965.099808741,964.1097345679,977.7582725885,1037.9025489066,1212.0639554441,1202.6074530117].map(value => value/60),
  name: 'Casual Members',
  type: 'scatter',
  yaxis: 'y2'
}];
...
let data0 = [{
  x: ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"],
  y: [674.6071379266,682.8943037879,686.4112823516,693.6473895289,696.0181270188,748.0477170674,731.6343266915].map(value => value/60),
  name: 'Annual Members',
  type: 'scatter',
  yaxis: 'y2'
}];
...
let layout2 = {
  title: {
    text: 'Days of the Week of Casual vs. Members',
    font: {
      family: 'Arial, sans-serif',
      size: 40,
      bold: true
...
var layout4 = {
  title: {
    text: 'Hourly Average of Casual vs. Members',
    font: {
      family: 'Arial, sans-serif',
      size: 40,
      bold: true
